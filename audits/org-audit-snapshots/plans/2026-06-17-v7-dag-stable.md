...
| **T1.7** | Open PR for HOOKS_SKIP=1 env-var spec in `phenotype-tooling` | P0 | orchestrator | T1.4 | 1 PR opened in `<REDACTED>/phenotype-tooling` documenting `HOOKS_SKIP=1` and `SKIP=pre-push,pre-commit` env vars; links to AGENTS.md |
