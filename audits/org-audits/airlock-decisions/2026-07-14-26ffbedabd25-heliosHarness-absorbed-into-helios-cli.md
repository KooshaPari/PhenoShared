...
**Decision:** Absorbed into [`<REDACTED>/helios-cli`](https://github.com/KooshaPari/helios-cli) as the `harness_recorder` crate + HeliosCLI workspace. No recreation needed.
