...
SSH_KEY="ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILZZVKELp+/rncu0lMKS2N7DSP/nAsgvnhzPQ7AP5ubt <REDACTED>@gmail.com"
...
echo "  ssh <REDACTED>-desk"
echo "  tailscale ssh <REDACTED>-desk"
echo ""
echo "Or add to ~/.ssh/config:"
echo "  Host <REDACTED>-desk desk"
echo "    HostName <REDACTED>-desk.tail2b570.ts.net"
echo "    User <REDACTED>"
