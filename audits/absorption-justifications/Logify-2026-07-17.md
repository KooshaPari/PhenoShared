...
**Source Repo:** `gh api repos/<REDACTED>/Logify` (remote)
...
`Logify` is the **library** repo owned by `<REDACTED>`.
...
gh repo archive <REDACTED>/Logify  # archive after absorption PR merges
git clone https://github.com/<REDACTED>/Logify.git /tmp/Logify-pre-absorption
```
