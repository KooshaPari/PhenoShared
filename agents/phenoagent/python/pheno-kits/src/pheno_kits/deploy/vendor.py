...
Handles vendoring of pheno-sdk packages for production deployments. Provides
programmatic access to replace custom shell scripts.
"""
...
''',
    ...
    def validate_vendored(
        ...
        if packages is None:
            vendored_packages = [
                d.name
                for d in self.vendor_dir.iterdir()
