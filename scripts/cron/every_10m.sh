...
PHENO_ROOT="${PHENO_ROOT:-/Users/kooshapari/CodeProjects/Phenotype/pheno-harness}"
...
if curl -sL --max-time 3 http://127.0.0.1:8765/v1/models >/dev/null 2>&1; then
    ...
    SNAP=$(ls -d /Users/kooshapari/.cache/huggingface/hub/models--Qwen--Qwen3.5-0.8B/snapshots/*/ | head -1)
