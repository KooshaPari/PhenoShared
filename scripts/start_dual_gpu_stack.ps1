...
$WslModel = if ($env:PHENO_QWEN35_08B_HF) { $env:PHENO_QWEN35_08B_HF } else { "/home/kooshapari/.cache/huggingface/hub/models--Qwen--Qwen3.5-0.8B/snapshots/2fc06364715b967f1860aea9cf38778875588b17" }
$WslVllmPython = if ($env:PHENO_VLLM_PYTHON) { $env:PHENO_VLLM_PYTHON } else { "/home/kooshapari/mambaforge/envs/vllm/bin/python" }
