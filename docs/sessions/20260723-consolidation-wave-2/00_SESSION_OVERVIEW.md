# Repository Consolidation Wave 2

## Goal

Govern the exact 20-repository Wave 2 docket through live-remote, local-preservation, and
canonical-boundary gates. Preserve all unique history before reducing the GitHub footprint.
...
The authoritative per-repository evidence is `artifacts/wave-2-repository-evidence.tsv`.
