...
| Metron | HexaKit `Metron/` | **VERIFIED** | excluded + stub pruned ([#244](https://github.com/<REDACTED>/HexaKit/pull/244), [#251](https://github.com/<REDACTED>/HexaKit/pull/251)); canonical `metrickit` in PhenoObservability |
