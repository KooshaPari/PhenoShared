# Depletion Batch 6 — Delete Proposals (2026-07-17)
...
|---|---|---|---|
|  1 | `worktrees` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  2 | `zig` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  3 | `4sgm-archive` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  4 | `AgilePlus-recovery-20260714` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  5 | `AgilePlus-recovery-evidence-20260714` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  6 | `Archives-phenotype-duplicates-20260329-phenotype-contracts` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  7 | `Archives-phenotype-duplicates-20260329-phenotype-event-sourcing` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  8 | `Eventra-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  9 | `Httpora-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
| 10 | `ObservabilityKit-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
...
- [ ] Batch 6 reviewed and approved by Koosha
