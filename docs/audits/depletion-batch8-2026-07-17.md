# Depletion Batch 8 — Delete Proposals (2026-07-17)
...
|---|---|---|---|
|  1 | `Tracera-electrobun-recovery-20260715` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  2 | `Tracera-jwks-runtime-recovery-20260715` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  3 | `Tracera-jwt-contract-recovery-wt` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  4 | `Tracera-recovery-20260713` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  5 | `Tracera-workos-20260715` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  6 | `Tracera-workos-hostname-reconcile-20260715` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  7 | `agent-user-status` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  8 | `agent-user-status-archive` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  9 | `agileplus-spec-harmonizer-tool-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
| 10 | `airlock-v2-smoke-test-15055` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
...
- [ ] Batch 8 reviewed and approved by Koosha
