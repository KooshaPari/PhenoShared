# Depletion Batch 16 — Delete Proposals (2026-07-17)
...
|---|---|---|---|
|  1 | `Dino` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  2 | `Eidolon` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  3 | `FocalPoint` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  4 | `Forgecode` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  5 | `Grapheon` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  6 | `HeliosLab` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  7 | `HeliosLab-lab` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  8 | `HeliosLab-snap` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  9 | `HeliosLab_archive` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
| 10 | `HexaKit` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
...
- [ ] Batch 16 reviewed and approved by Koosha
