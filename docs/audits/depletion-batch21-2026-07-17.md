# Depletion Batch 21 — Delete Proposals (2026-07-17)

## Summary

| Category | Count |
|---|---|
| `C:TOO_LARGE_RETIRE` | 9 |
...
|---|---|---|---|
|  1 | `phenoResearchEngine-archive` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  2 | `phenotype-Org-RFCs` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  3 | `phenotype-gateway` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  4 | `phenotype-gfx` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  5 | `phenotype-landing` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  6 | `tehgent` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  7 | `thegent` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  8 | `thegent-workspace` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  9 | `tokn` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
...
- [ ] Batch 21 reviewed and approved by Koosha
