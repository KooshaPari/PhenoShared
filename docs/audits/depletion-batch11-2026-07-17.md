# Depletion Batch 11 — Delete Proposals (2026-07-17)
...
|---|---|---|---|
|  1 | `phenotype-sdk-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  2 | `phenotype-shared-archive` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  3 | `repos-pre-delete-dirty-snapshots-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  4 | `services-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  5 | `subject-app-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  6 | `subject-recovery-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  7 | `substrate-adapters-bundle-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  8 | `substrate-recovery-20260714` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
|  9 | `thegent-dispatch-archive-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
| 10 | `thegent-pr2-v2-uncommitted-2026-07-14` | `H:RECOVERY_SNAPSHOT` | 🟡 REVIEW |
...
- [ ] Batch 11 reviewed and approved by Koosha
