# Depletion Batch 17 — Delete Proposals (2026-07-17)
...
|---|---|---|---|
|  1 | `KDesktopVirt` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  2 | `KVirtualStage` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  3 | `KWatch` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  4 | `KodeVibe` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  5 | `KodeVibeGo` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  6 | `Logify` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  7 | `MCPForge` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  8 | `PhenoCompose` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  9 | `PhenoPlugins` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
| 10 | `PhenoProject` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
...
- [ ] Batch 17 reviewed and approved by Koosha
