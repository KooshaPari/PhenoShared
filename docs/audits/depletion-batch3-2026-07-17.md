# Depletion Batch 3 — Delete Proposals (2026-07-17)
...
|---|---|---|---|
|  1 | `.team-status` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  2 | `.worktrees` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  3 | `OmniRoute-superroot-recovery` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  4 | `_archive` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  5 | `_cockpit` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  6 | `_phenofleet-decisions` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  7 | `_session_preserved` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  8 | `audit-tool` | `G:AUTO_IMPORT` | 🟢 SAFE |
|  9 | `backend` | `G:AUTO_IMPORT` | 🟢 SAFE |
| 10 | `bench-results` | `G:AUTO_IMPORT` | 🟢 SAFE |
...
- [ ] Batch 3 reviewed and approved by Koosha
