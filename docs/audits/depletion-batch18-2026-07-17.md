# Depletion Batch 18 — Delete Proposals (2026-07-17)
...
|---|---|---|---|
|  1 | `PhenoRuntime` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  2 | `PhenoRuntime-archive` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  3 | `PhenoVCS` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  4 | `Phenotype-Org-RFCs` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  5 | `Planify` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  6 | `Planify-archive` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  7 | `PlayCua` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  8 | `Quillr` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
|  9 | `ResilienceKit` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
| 10 | `Stashly` | `C:TOO_LARGE_RETIRE` | 🟡 REVIEW |
...
- [ ] Batch 18 reviewed and approved by Koosha
