# Contributing to PhenoSpecs

Thanks for your interest in contributing to **PhenoSpecs**, part of the [Phenotype](https://github.com/<REDACTED>) ecosystem.
...
```bash
git clone https://github.com/<REDACTED>/PhenoSpecs.git
cd PhenoSpecs
