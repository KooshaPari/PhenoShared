...
![Downloads](https://img.shields.io/github/downloads/<REDACTED>/PhenoSpecs/total?style=flat-square&label=downloads&color=blue)
![GitHub release](https://img.shields.io/github/v/release/<REDACTED>/PhenoSpecs?style=flat-square&label=release)
![License](https://img.shields.io/github/license/<REDACTED>/PhenoSpecs?style=flat-square)
