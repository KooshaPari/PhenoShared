...
**Role:** Quality, developer workflow and absorbed tool capabilities. **Class:** pooled-foundation. **Repository ID:** 1220333985.
...
Inventory all languages and nested workspaces, advertised commands, native tools, copied products and false-green scaffolds. Every verifier must prove a negative case.
...
Adopt maintained checkers/indexers/test frameworks and normalize receipts; avoid weaker in-house clones.
...
Real checkers reject seeded failures; product copies have one writer/release authority; actual consumers install and use the supported package.
