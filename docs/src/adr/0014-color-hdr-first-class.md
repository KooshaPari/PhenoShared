# ADR 0014 — Make color and HDR intent authoritative graph metadata
...
The C27HG70 and M1 Pro XDR panel have different luminance, gamut, refresh, and HDR behavior. Nominal RGB values alone are insufficient.
...
Ports advertise bit depth, primaries, transfer, luminance, ICC/EDID, HDR and refresh capabilities. Routes record preservation or explicit transform. Desktop text, gaming, color-critical, and video profiles differ.
...
- **Alternative 1:** Treat HDR as a boolean
- **Alternative 2:** Always convert to sRGB/SDR
- **Alternative 3:** Always 4:4:4 regardless bandwidth
- **Alternative 4:** Trust display marketing specs only
...
- Users can see when content is preserved or converted.
- Test patterns and real displays are required.
- Route selection includes color quality and codec pressure.
