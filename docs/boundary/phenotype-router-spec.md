---
repo: "phenotype-router-spec"
role: spec
status: absorbed
absorbed_into: "phenotype-registry"
absorbed_at: "docs/specs/router-protocol/"
absorbed_date: 2026-07-17
last_boundary_review: 2026-07-17
review_cadence: never (absorbed)
---

# Boundary — phenotype-router-spec (ABSORBED)

## Disposition

**ABSORBED** into `phenotype-registry/docs/specs/router-protocol/` on 2026-07-17.

The phenotype-router-spec repo contained 4 JSON schemas (router-dispatch, router-mailbox,
router-trace, router-artifact) and 5 markdown protocol docs describing the A2A wire protocol
between substrate engines, drivers, and adapters. This content is now hosted directly in the
canonical ecosystem INDEX (phenotype-registry).
