...
|------|--------|----------|
| Auth/policy contract traits landed in Authvault | **done** | [Authvault#88](https://github.com/<REDACTED>/Authvault/pull/88) — `rust/phenotype-auth-contracts` |
| Disposition doc | **done** | Authvault `docs/disposition/p4-contracts-slice2-auth-policy.md` |
| Consumer repoint: `phenotype-python-sdk` auth-kit | **done** | [python-sdk#22](https://github.com/<REDACTED>/phenotype-python-sdk/pull/22) — vendored generic copy dropped; git-pin `phenotype-auth-contracts` |
