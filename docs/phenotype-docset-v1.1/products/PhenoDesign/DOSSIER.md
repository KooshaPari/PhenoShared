# PhenoDesign: role-specific atlas and qualification

**Role:** Shared visual identity, tokens, components and creative-source custody. **Class:** supporting-surface. **Repository ID:** 1169864396.
...
Locate editable source, export recipes, actual consumers and accepted brand scope. Do not regenerate a brand because a legacy README says archived.
...
Use established design-token formats, accessible UI libraries, Blender/Adobe and appropriate exporters.
...
Real consumers use consistent tokens/assets; visual, accessibility, performance and rights checks pass; source edits reproducibly produce deliverable variants.
