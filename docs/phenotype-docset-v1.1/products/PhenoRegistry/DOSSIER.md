# PhenoRegistry: role-specific atlas and qualification

**Role:** Curated portfolio identity and ownership projection. **Class:** supporting-surface. **Repository ID:** 1201113097.
...
Use immutable repo IDs and explicit accepted lifecycle/role records. Separate GitHub facts from proposed disposition and externally owned work/evidence state.
...
Adapt small declarative catalogs or Backstage concepts; no new universal database.
...
The live roster resolves aliases, names current allowed actions and links truthful evidence without overriding source owners.
