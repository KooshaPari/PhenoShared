...
Map each public claim to an actual product/release, active URL, docs version and artifact. Preserve private/public boundaries and honest installation status.
...
Reuse the existing landing/PhenoDocs composition and platform deployment facilities rather than build another registry.
...
An unfamiliar visitor can understand the portfolio, find working product/docs/install paths and distinguish measured capability from plans.
