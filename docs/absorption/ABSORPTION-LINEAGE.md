...
|---|---|---|---|
| `docs/absorption/phenotype-pm-core/README.md:8-9` | `crates/traceability-core/`, `crates/traceability-decorators/`, `crates/trace-gate/` | **RESOLVED 2026-09-20** — all 3 restored from `phenotype-archive.bundle` to canonical paths. `cargo check` passes; 101/102 tests pass. The old partial at `crates/agile-plus/crates/traceability-core` is orphaned gitignored, strictly superseded | ~~**HIGH** — a 3-crate absorption is documented as complete and left nothing~~ **done** |
