# Plan: Packaging, Deployment, Upgrade, and Recovery
...
|---|---|---|
| WP-001 | Component/privilege manifest | — |
| WP-002 | Linux packaging and service lifecycle | WP-001 |
| WP-003 | Windows packaging and driver lifecycle | WP-001 |
| WP-004 | macOS packaging/notarization/permissions | WP-001 |
| WP-005 | Enrollment, config, and schema migration | WP-002, WP-003, WP-004 |
| WP-006 | Update, repair, rollback, uninstall | WP-005 |
| WP-007 | Recovery/OOB and diagnostic bundle | WP-005 |
| WP-008 | Release channels and clean-machine acceptance | WP-006, WP-007 |

```mermaid
flowchart LR
    WP_001["WP-001: Component/privilege manifest"]
    WP_001 --> WP_002["WP-002: Linux packaging and service lifecycle"]
    WP_001 --> WP_003["WP-003: Windows packaging and driver lifecycle"]
    WP_001 --> WP_004["WP-004: macOS packaging/notarization/permissions"]
    WP_002 --> WP_005["WP-005: Enrollment, config, and schema migration"]
    WP_003 --> WP_005["WP-005: Enrollment, config, and schema migration"]
    WP_004 --> WP_005["WP-005: Enrollment, config, and schema migration"]
    WP_005 --> WP_006["WP-006: Update, repair, rollback, uninstall"]
    WP_005 --> WP_007["WP-007: Recovery/OOB and diagnostic bundle"]
    WP_006 --> WP_008["WP-008: Release channels and clean-machine acceptance"]
    WP_007 --> WP_008["WP-008: Release channels and clean-machine acceptance"]
```
