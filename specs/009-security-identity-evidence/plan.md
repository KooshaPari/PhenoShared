# Plan: Security, Identity, Leases, Audit, and Evidence
...
|---|---|---|
| WP-001 | Threat model and capability matrix | — |
| WP-002 | Device identity and pairing | WP-001 |
| WP-003 | Authorization token and policy engine | WP-001, WP-002 |
| WP-004 | Privileged helper isolation | WP-001 |
| WP-005 | Lease/fencing service | WP-003 |
| WP-006 | Audit/evidence bundle format | WP-003, WP-004 |
| WP-007 | OOB management isolation | WP-001, WP-002 |
| WP-008 | Red-team, partition, and recovery validation | WP-005, WP-006, WP-007 |

```mermaid
flowchart LR
    WP_001["WP-001: Threat model and capability matrix"]
    WP_001 --> WP_002["WP-002: Device identity and pairing"]
    WP_001 --> WP_003["WP-003: Authorization token and policy engine"]
    WP_002 --> WP_003["WP-003: Authorization token and policy engine"]
    WP_001 --> WP_004["WP-004: Privileged helper isolation"]
    WP_003 --> WP_005["WP-005: Lease/fencing service"]
    WP_003 --> WP_006["WP-006: Audit/evidence bundle format"]
    WP_004 --> WP_006["WP-006: Audit/evidence bundle format"]
    WP_001 --> WP_007["WP-007: OOB management isolation"]
    WP_002 --> WP_007["WP-007: OOB management isolation"]
    WP_005 --> WP_008["WP-008: Red-team, partition, and recovery validation"]
    WP_006 --> WP_008["WP-008: Red-team, partition, and recovery validation"]
    WP_007 --> WP_008["WP-008: Red-team, partition, and recovery validation"]
```

**Critical path:** WP-001 → WP-002 → WP-003 → WP-005 → WP-008
