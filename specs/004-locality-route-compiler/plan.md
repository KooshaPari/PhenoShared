# Plan: Locality-Aware Route Compiler and Transport Plane
...
|---|---|---|
| WP-001 | Locality and stage schema | — |
| WP-002 | Topology/capability probes | WP-001 |
| WP-003 | Same-OS/same-host route implementations | WP-002 |
| WP-004 | KVMFR/IVSHMEM/virtio adapters | WP-003 |
| WP-005 | LAN direct transport and quality negotiation | WP-001, WP-002 |
| WP-006 | WAN/NAT/relay transport | WP-005 |
| WP-007 | Compiler cost model and explanations | WP-003, WP-005 |
| WP-008 | Transactional replan and fallback | WP-004, WP-006, WP-007 |
| WP-009 | Topology and contention benchmark matrix | WP-008 |

```mermaid
flowchart LR
    WP_001["WP-001: Locality and stage schema"]
    WP_001 --> WP_002["WP-002: Topology/capability probes"]
    WP_002 --> WP_003["WP-003: Same-OS/same-host route implementations"]
    WP_003 --> WP_004["WP-004: KVMFR/IVSHMEM/virtio adapters"]
    WP_001 --> WP_005["WP-005: LAN direct transport and quality negotiation"]
    WP_002 --> WP_005["WP-005: LAN direct transport and quality negotiation"]
    WP_005 --> WP_006["WP-006: WAN/NAT/relay transport"]
    WP_003 --> WP_007["WP-007: Compiler cost model and explanations"]
    WP_005 --> WP_007["WP-007: Compiler cost model and explanations"]
    WP_004 --> WP_008["WP-008: Transactional replan and fallback"]
    WP_006 --> WP_008["WP-008: Transactional replan and fallback"]
    WP_007 --> WP_008["WP-008: Transactional replan and fallback"]
    WP_008 --> WP_009["WP-009: Topology and contention benchmark matrix"]
```

**Critical path:** WP-001 → WP-002 → WP-003 → WP-004 → WP-008 → WP-009
