# Plan: Real-Time QoS, Admission, and Contention Control
...
|---|---|---|
| WP-001 | Service-class and deadline schema | — |
| WP-002 | CPU scheduling/isolation adapters | WP-001 |
| WP-003 | GPU/codec/VRAM pressure and reservations | WP-001 |
| WP-004 | Storage/network/memory pressure control | WP-001 |
| WP-005 | Admission and degradation engine | WP-002, WP-003, WP-004 |
| WP-006 | Ableton RT island prototype | WP-002, WP-005 |
| WP-007 | Gaming/frame-time protection prototype | WP-003, WP-005 |
| WP-008 | Mixed workload/fault validation | WP-006, WP-007 |

```mermaid
flowchart LR
    WP_001["WP-001: Service-class and deadline schema"]
    WP_001 --> WP_002["WP-002: CPU scheduling/isolation adapters"]
    WP_001 --> WP_003["WP-003: GPU/codec/VRAM pressure and reservations"]
    WP_001 --> WP_004["WP-004: Storage/network/memory pressure control"]
    WP_002 --> WP_005["WP-005: Admission and degradation engine"]
    WP_003 --> WP_005["WP-005: Admission and degradation engine"]
    WP_004 --> WP_005["WP-005: Admission and degradation engine"]
    WP_002 --> WP_006["WP-006: Ableton RT island prototype"]
    WP_005 --> WP_006["WP-006: Ableton RT island prototype"]
    WP_003 --> WP_007["WP-007: Gaming/frame-time protection prototype"]
    WP_005 --> WP_007["WP-007: Gaming/frame-time protection prototype"]
    WP_006 --> WP_008["WP-008: Mixed workload/fault validation"]
    WP_007 --> WP_008["WP-008: Mixed workload/fault validation"]
```

**Critical path:** WP-001 → WP-002 → WP-005 → WP-006 → WP-008
