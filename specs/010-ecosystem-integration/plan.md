# Plan: Phenotype Ecosystem Integration and Product Boundaries
...
|---|---|---|
| WP-001 | Authority and entity ownership matrix | — |
| WP-002 | Shared ID/event envelope schema | WP-001 |
| WP-003 | ShareCLI adapter | WP-002 |
| WP-004 | NVMS/thegent runtime contracts | WP-002 |
| WP-005 | AgilePlus/AGSLAG policy inputs | WP-002 |
| WP-006 | Tracera/SessionLedger evidence outputs | WP-002 |
| WP-007 | labs-compute graduation process | WP-001 |
| WP-008 | End-to-end intent-to-evidence demonstration | WP-003, WP-004, WP-005, WP-006 |

```mermaid
flowchart LR
    WP_001["WP-001: Authority and entity ownership matrix"]
    WP_001 --> WP_002["WP-002: Shared ID/event envelope schema"]
    WP_002 --> WP_003["WP-003: ShareCLI adapter"]
    WP_002 --> WP_004["WP-004: NVMS/thegent runtime contracts"]
    WP_002 --> WP_005["WP-005: AgilePlus/AGSLAG policy inputs"]
    WP_002 --> WP_006["WP-006: Tracera/SessionLedger evidence outputs"]
    WP_001 --> WP_007["WP-007: labs-compute graduation process"]
    WP_003 --> WP_008["WP-008: End-to-end intent-to-evidence demonstration"]
    WP_004 --> WP_008["WP-008: End-to-end intent-to-evidence demonstration"]
    WP_005 --> WP_008["WP-008: End-to-end intent-to-evidence demonstration"]
    WP_006 --> WP_008["WP-008: End-to-end intent-to-evidence demonstration"]
```

**Critical path:** WP-001 → WP-002 → WP-003 → WP-008
