# Plan: Adaptive Heterogeneous Compute and Data Fabric
...
|---|---|---|
| WP-001 | Resource/topology descriptor and probes | — |
| WP-002 | Object identity, residency, local shared store | WP-001 |
| WP-003 | TaskSpec and execution-region API | WP-001 |
| WP-004 | Baseline cost model and scheduler | WP-002, WP-003 |
| WP-005 | ShareCLI/NVMS/thegent execution adapters | WP-003 |
| WP-006 | Prefetch, replication, spill, and result routing | WP-002, WP-004 |
| WP-007 | Fusion/fission and predictive placement | WP-004, WP-006 |
| WP-008 | Selective interposition and mobility experiments | WP-005, WP-007 |
| WP-009 | Adversarial mixed-workload evaluation | WP-008 |

```mermaid
flowchart LR
    WP_001["WP-001: Resource/topology descriptor and probes"]
    WP_001 --> WP_002["WP-002: Object identity, residency, local shared store"]
    WP_001 --> WP_003["WP-003: TaskSpec and execution-region API"]
    WP_002 --> WP_004["WP-004: Baseline cost model and scheduler"]
    WP_003 --> WP_004["WP-004: Baseline cost model and scheduler"]
    WP_003 --> WP_005["WP-005: ShareCLI/NVMS/thegent execution adapters"]
    WP_002 --> WP_006["WP-006: Prefetch, replication, spill, and result routing"]
    WP_004 --> WP_006["WP-006: Prefetch, replication, spill, and result routing"]
    WP_004 --> WP_007["WP-007: Fusion/fission and predictive placement"]
    WP_006 --> WP_007["WP-007: Fusion/fission and predictive placement"]
    WP_005 --> WP_008["WP-008: Selective interposition and mobility experiments"]
    WP_007 --> WP_008["WP-008: Selective interposition and mobility experiments"]
    WP_008 --> WP_009["WP-009: Adversarial mixed-workload evaluation"]
```

**Critical path:** WP-001 → WP-002 → WP-004 → WP-006 → WP-007 → WP-008 → WP-009
