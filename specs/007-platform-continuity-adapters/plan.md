# Plan: Cross-Platform Continuity, Audio, Clipboard, and Files
...
|---|---|---|
| WP-001 | Platform capability/permission matrix | — |
| WP-002 | Linux PipeWire/JACK and portal adapters | WP-001 |
| WP-003 | Windows audio/clipboard/file adapters | WP-001 |
| WP-004 | macOS audio/clipboard/file adapters | WP-001 |
| WP-005 | Network audio clock and buffer engine | WP-002, WP-003, WP-004 |
| WP-006 | Typed clipboard and direct transfer | WP-002, WP-003, WP-004 |
| WP-007 | Sync and mount integrations | WP-006 |
| WP-008 | Cross-platform continuity acceptance | WP-005, WP-007 |

```mermaid
flowchart LR
    WP_001["WP-001: Platform capability/permission matrix"]
    WP_001 --> WP_002["WP-002: Linux PipeWire/JACK and portal adapters"]
    WP_001 --> WP_003["WP-003: Windows audio/clipboard/file adapters"]
    WP_001 --> WP_004["WP-004: macOS audio/clipboard/file adapters"]
    WP_002 --> WP_005["WP-005: Network audio clock and buffer engine"]
    WP_003 --> WP_005["WP-005: Network audio clock and buffer engine"]
    WP_004 --> WP_005["WP-005: Network audio clock and buffer engine"]
    WP_002 --> WP_006["WP-006: Typed clipboard and direct transfer"]
    WP_003 --> WP_006["WP-006: Typed clipboard and direct transfer"]
    WP_004 --> WP_006["WP-006: Typed clipboard and direct transfer"]
    WP_006 --> WP_007["WP-007: Sync and mount integrations"]
    WP_005 --> WP_008["WP-008: Cross-platform continuity acceptance"]
    WP_007 --> WP_008["WP-008: Cross-platform continuity acceptance"]
```
