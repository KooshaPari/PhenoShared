...
describe("benchora-landing smoke", () => {
  ...
  it("repo snapshot is valid JSON with expected shape", () => {
    ...
    expect(repo.full_name).toBe("<REDACTED>/Benchora");
