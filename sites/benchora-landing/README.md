...
> Astro 6 + Tailwind 4 + Vercel live at benchora.phenotype.space; build-time GitHub README fetch wired; QA dashboard in progress. · updated 2026-06-21

<!-- work-state: benchora-landing -->

# benchora-landing

Landing page at `benchora.phenotype.space` for [<REDACTED>/Benchora](https://github.com/KooshaPari/Benchora).
...
- `src/data/readme.html` — rendered Benchora README
...
- `/` — landing (this repo)
- `/docs` — VitePress docs (mounted from Benchora/docs)
