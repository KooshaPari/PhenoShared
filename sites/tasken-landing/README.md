...
> Astro 5 + Tailwind 4 + Vercel live at tasken.phenotype.space; build-time GitHub README fetch wired; QA dashboard in progress. · updated 2026-06-08

<!-- work-state: tasken-landing -->

# tasken-landing

Landing page at `tasken.phenotype.space` for [<REDACTED>/Tasken](https://github.com/KooshaPari/Tasken).
...
- `src/data/readme.html` — rendered Tasken README
...
- `/` — landing (this repo)
- `/docs` — VitePress docs (mounted from Tasken/docs)
