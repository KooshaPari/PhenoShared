...
> **SUPERSEDED (execution):** Monorepo absorption into HexaKit is **retired** per [ADR-ECO-006](docs/adrs/ADR-ECO-006.md). Authoritative: [boundary-shaping.md](docs/rationalization/boundary-shaping.md) + [HexaKit DISPOSITION](https://github.com/<REDACTED>/HexaKit/blob/main/docs/boundary/DISPOSITION.md). Below is historical inventory.
...
> SUPERSEDED, not archived-after-extract. Absorbing PR: [phenotype-gfx#10](https://github.com/<REDACTED>/phenotype-gfx/pull/10)
...
|-------------|------------------------------|-----|-------------------------|--------------------------|
| `<REDACTED>/phenotype-voxel` | `phenotype-gfx/crates/voxel` | [phenotype-gfx#10](https://github.com/<REDACTED>/phenotype-gfx/pull/10) (merged) | voxel substrate (adaptive voxel) | AFFIRM → **SUPERSEDE → ARCHIVED** |
| `<REDACTED>/phenotype-terrain` | `phenotype-gfx/crates/unity-terrain-shim` | [phenotype-gfx#10](https://github.com/<REDACTED>/phenotype-gfx/pull/10) (merged) | Unity terrain bridge | AFFIRM → **SUPERSEDE → ARCHIVED** |
| `<REDACTED>/phenotype-water` | `phenotype-gfx/crates/unity-water-shim` | [phenotype-gfx#10](https://github.com/<REDACTED>/phenotype-gfx/pull/10) (merged) | Unity water bridge | AFFIRM → **SUPERSEDE → ARCHIVED** |
| `<REDACTED>/phenotype-postfx` | `phenotype-gfx/crates/unity-postfx-shim` | [phenotype-gfx#10](https://github.com/<REDACTED>/phenotype-gfx/pull/10) (merged) | Unity BRP post-FX | (new entry) → **SUPERSEDE → ARCHIVED** |
