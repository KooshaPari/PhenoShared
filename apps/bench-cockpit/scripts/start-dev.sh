...
DEFAULT_V5_NATIVE="/Users/<REDACTED>/CodeProjects/Phenotype/repos/pheno-harness/bench/results/stock-vs-ours/run-v5-qwen35-08b.json"
DEFAULT_V5_CONTRACT="/Users/<REDACTED>/CodeProjects/Phenotype/repos/pheno-harness/bench/results/stock-vs-ours/run-v5-qwen35-08b-contract.json"
DEFAULT_MINIMAX_MATRIX="/Users/<REDACTED>/CodeProjects/Phenotype/repos/pheno-harness/bench/results/minimax-m3-full/matrix.json"
