# Migration: phenotype-cli-core → canonical owner
...
```toml
`phenotype-cli-core` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-cli-core` as a workspace member.
