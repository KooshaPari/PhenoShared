...
We take the security of `pheno-port-adapter` seriously. If you believe you
...
1. Notify us as soon as possible of the discovery
2. Give us a reasonable time to respond and fix the issue
3. Make every effort to minimise the risk and impact to users during disclosure
