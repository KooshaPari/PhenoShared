...
├── Consumes: github.com/<REDACTED>/CLIProxyAPI/v7 v7.0.0 (fork-only, internal)
...
### CLIProxy API
```go
import cliproxy "github.com/<REDACTED>/CLIProxyAPI/v7" // fork-only internal module
...
go get -u github.com/<REDACTED>/CLIProxyAPI/v7
