# Migration: phenotype-retry → canonical owner
...
```toml
`phenotype-retry` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-retry` as a workspace member.
