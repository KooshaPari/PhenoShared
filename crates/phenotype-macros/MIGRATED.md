# Migration: phenotype-macros → canonical owner
...
```toml
`phenotype-macros` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-macros` as a workspace member.
