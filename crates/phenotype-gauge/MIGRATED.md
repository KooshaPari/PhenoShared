# Migration: phenotype-gauge → canonical owner
...
```toml
`phenotype-gauge` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-gauge` as a workspace member.
