# Migration: phenotype-dep-guard → canonical owner
...
```toml
`phenotype-dep-guard` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-dep-guard` as a workspace member.
