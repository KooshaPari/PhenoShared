# Migration: phenotype-shared → canonical owner
...
```toml
`phenotype-shared` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-shared` as a workspace member.
