# Migration: phenotype-mock → canonical owner
...
```toml
`phenotype-mock` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-mock` as a workspace member.
