# Migration: phenotype-telemetry → canonical owner
...
```toml
`phenotype-telemetry` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-telemetry` as a workspace member.
