# Migration: phenotype-hub → canonical owner
...
```toml
`phenotype-hub` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-hub` as a workspace member.
