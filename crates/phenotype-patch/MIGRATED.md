# Migration: phenotype-patch → canonical owner
...
```toml
`phenotype-patch` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-patch` as a workspace member.
