# Migration: phenotype-core → canonical owner
...
```toml
`phenotype-core` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-core` as a workspace member.
