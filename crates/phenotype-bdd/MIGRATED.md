# Migration: phenotype-bdd → canonical owner
...
```toml
`phenotype-bdd` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-bdd` as a workspace member.
