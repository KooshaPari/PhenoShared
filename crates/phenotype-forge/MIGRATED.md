# Migration: phenotype-forge → canonical owner
...
```toml
`phenotype-forge` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-forge` as a workspace member.
