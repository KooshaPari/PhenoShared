//! Engine catalog, argv enrichment, and plan printing for the composition root.
...
/// Print a dispatch plan as pretty JSON (dry-run / `plan` subcommand).
pub fn print_plan(plan: &DispatchPlan) -> anyhow::Result<()> {
