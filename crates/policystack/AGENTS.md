...
- **Phenotype org governance:** `/Users/<REDACTED>/CodeProjects/Phenotype/repos/CLAUDE.md`
...
3. **Worktrees:** Use `repos/PolicyStack-wtrees/<topic>/` for feature work
