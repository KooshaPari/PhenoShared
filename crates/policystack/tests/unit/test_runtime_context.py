...
class RuntimeContextTest(unittest.TestCase):
    def test_infer_repo_name_from_worktree_cwd(self) -> None:
        ...
        assert infer_repo_name_from_cwd("/Users/<REDACTED>/CodeProjects/Phenotype/repos/trace-wtrees/cli-stubs") == "trace"

    def test_infer_repo_name_from_nested_worktrees_layout(self) -> None:
        assert infer_repo_name_from_cwd("/Users/<REDACTED>/CodeProjects/Phenotype/repos/worktrees/heliosApp/claude-md-standardize") == "heliosApp"
