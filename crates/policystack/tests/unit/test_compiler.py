...
class CompilerTest(unittest.TestCase):
    ...
    def test_codex_compile_surfaces_host_safe_allow_prefixes(self) -> None:
        ...
        assert "mkdir -p /Users/<REDACTED>/CodeProjects/Phenotype/repos/*" in permissions["allow_prefixes"]
        ...
        assert "mv /Users/<REDACTED>/CodeProjects/Phenotype/repos/* /Users/<REDACTED>/CodeProjects/Phenotype/repos/.archive/*" in permissions["allow_prefixes"]
        assert "rm -rf /Users/<REDACTED>/CodeProjects/Phenotype/repos/*" in permissions["deny_prefixes"]
