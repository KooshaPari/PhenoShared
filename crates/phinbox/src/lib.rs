//! phinbox — native OS popup elicitation for autonomous agents.
//!
...
/// and the CLI uses it for `phinbox schema`.
#[must_use]
...
///
/// Useful for the CLI's `phinbox detect` subcommand and for the agent's
