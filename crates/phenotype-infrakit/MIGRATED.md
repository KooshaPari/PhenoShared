# Migration: phenotype-infrakit → canonical owner
...
```toml
`phenotype-infrakit` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-infrakit` as a workspace member.
