...
pub struct Config {
    ...
    #[serde(default)]
    pub targets: Vec<crate::argis_monitor::target::Target>,
    ...
    #[serde(default)]
    pub alert_rules: Vec<crate::argis_monitor::alerts::AlertRule>,
    ...
    #[serde(default)]
    pub meta_alerts: Vec<crate::argis_monitor::alerts::MetaAlertRule>,
    ...
    #[serde(default)]
    pub alert_windows: Vec<crate::argis_monitor::suppression::WindowSpec>,
