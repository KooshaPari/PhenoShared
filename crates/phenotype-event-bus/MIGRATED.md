# Migration: phenotype-event-bus → canonical owner
...
```toml
`phenotype-event-bus` = { git = "https://github.com/<REDACTED>/HexaKit", branch = "main" }
```

## For Agentora maintainers

- Do not register `phenotype-event-bus` as a workspace member.
