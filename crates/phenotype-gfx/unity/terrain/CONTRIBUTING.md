...
Thanks for your interest in contributing to **phenotype-terrain**, part of the [Phenotype](https://github.com/<REDACTED>) ecosystem of shared packages for Unity/WorldBox mods.
...
```bash
git clone https://github.com/<REDACTED>/phenotype-terrain.git
